    ...
    <div class="container-fluid">
            ...
            <tr>
                <td colspan="2">
                  <div class="row">
                    <div class="col-md-8">
                      <!--To,<br />
                        ...
                        <input type="text" name="order_receiver_name" id="order_receiver_name" class="form-control input-sm" placeholder="輸入客戶姓名" />
                        <textarea name="order_receiver_address" id="order_receiver_address" class="form-control" placeholder="工程地點"></textarea>
                    </div>
                    <div class="col-md-4">
                      <!--Reverse Charge<br />-->
                      <input type="text" name="order_no" id="order_no" class="form-control input-sm" placeholder="輸入單號" />
                      <input type="text" name="order_date" id="order_date" class="form-control input-sm" readonly placeholder="輸入日期" />
                    </div>
                  </div>
                  <br />
                  <table id="invoice-item-table" class="table table-bordered">
                    <tr>
                      ...
                      <th width="7%">單價</th>
                      <th width="10%">合共</th>
                      <th width="12.5%" colspan="2">折扣 (%)</th>
                      <th width="12.5%" colspan="2">折扣 (-)</th>
                      <!--<th width="12.5%" colspan="2">Tax3 (%)</th>-->
                      <th width="10%" rowspan="2">金額（港元）</th>
                      <th width="3%" rowspan="2"></th>
                    </tr>
                    <tr>
                      <th></th>
                    ...
                    <tr>
                      <td><button type="button" name="add_subrow" id="add_subrow" class="btn btn-success btn-xs">+</button></td>
                      <td><span id="sr_no">1</span></td>
                      <!--<td><label for="pet-select"></label>
                        <select name="pets" id="item_name_select[]">
                        <option value="">--清拆工程--</option>
                        <option value="dog">清拆客廳及房間地台磚, 腳線, 天花線 (如有)</option>
                        <option value="cat">清拆廚房部份磚牆</option>
                        <option value="hamster">清拆廚房牆身磚及地台磚</option>
                        <option value="parrot">清拆廁所牆身磚及地台磚</option>
                        <option value="spider">清拆客廳及房間舊有傢俬及雜物</option>
                        <option value="goldfish">清拆廚房舊有傢俬及雜物</option>
                        <option value="goldfish">清拆廁所舊有傢俬及雜物</option>
                        </select></td>-->
              ...
              <tr>
                <td colspan="2" align="center">
                  ...
                  <input type="submit" name="create_invoice" id="create_invoice" class="btn btn-info" value="創建" />
                </td>
              </tr>
          </table>
        </div>
          ...
          for(j=1; j<=count; j++)
          {
            ...
            if(quantity > 0)
            {
              ...
              if(price > 0)
              {
                ...
                if(tax2_rate > 0)
                {
                  tax2_amount = parseFloat(tax2_rate);
      ...
      elseif(isset($_GET["update"]) && isset($_GET["id"]))
      {
        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            <tr>
              <td colspan="2" align="center"><h2 style="margin-top:10.5px">修改單</h2></td>
            </tr>
            <tr>
                <td colspan="2">
                  <div class="row">
                  ...
                  <table id="invoice-item-table" class="table table-bordered">
                    <tr>
                      ...
                      <th width="12.5%" colspan="2">折扣 (-)</th>
                      <!--<th width="12.5%" colspan="2">Tax3 (%)</th>-->
                      <th width="12.5%" rowspan="2">金額（港元）</th>
              ...
              <tr>
                <td colspan="2" align="center">
                  ...
                  <input type="submit" name="update_invoice" id="create_invoice" class="btn btn-info" value="修改" />
                </td>
              </tr>
          </table>
        </div>
      ...
      {
      ?>
      <h3 align="center">深 德 ( 香 港 ) 工程有限公司報價系統</h3>

      <br />
      <div align="right">
        <a href="invoice.php?add=1" class="btn btn-info btn-xs">新增</a>
      </div>
      <br />
